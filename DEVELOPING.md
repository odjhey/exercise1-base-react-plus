...
1. If you don't have write access to this repo, [fork it](https://github.com/odjhey/base-cra-on-steroids/fork)
1. Clone the repo
...
1. Write code
1. Create a [pull request on GitHub](https://github.com/odjhey/base-cra-on-steroids/pulls)
